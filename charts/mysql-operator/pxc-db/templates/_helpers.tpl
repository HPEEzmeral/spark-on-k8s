...
{{/*
Label to make service externally accessible it needs to be mapped through an ECP gateway port
*/}}
{{- define "pxc-external-service.labels" -}}
hpecp.hpe.com/hpecp-internal-gateway: {{ .Values.externalService.setGateway | quote }}
{{- end -}}
